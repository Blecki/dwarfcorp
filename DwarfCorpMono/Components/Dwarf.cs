...
namespace DwarfCorp
{
    public class Dwarf : Creature
    {
        ...
        public void Initialize(Texture2D dwarfSprites)
        {
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Falling, OrientedAnimation.Orientation.Left, dwarfSprites, 15.0f, frameWidth, frameHeight, 6, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Falling, OrientedAnimation.Orientation.Right, dwarfSprites, 15.0f, frameWidth, frameHeight, 5, 1);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Jumping, OrientedAnimation.Orientation.Left, dwarfSprites, 15.0f, frameWidth, frameHeight,    6, 0);
            Sprite.AddAnimation(Creature.CharacterMode.Jumping, OrientedAnimation.Orientation.Right, dwarfSprites, 15.0f, frameWidth, frameHeight,     5, 0);
