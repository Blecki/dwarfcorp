...
namespace DwarfCorp
{
    class SkyRenderer
    {
        ...
        {
            SkyEffect.Parameters["SkyBoxTexture"].SetValue(SkyTexture);
            SkyEffect.Parameters["View"].SetValue(camera.ViewMatrix);
            SkyEffect.Parameters["Projection"].SetValue(camera.ProjectionMatrix);
            SkyEffect.Parameters["CameraPosition"].SetValue(camera.Position);
            SkyEffect.Parameters["World"].SetValue(Matrix.CreateScale(10) * Matrix.CreateTranslation(camera.Position));
            ...
            SkyEffect.CurrentTechnique = SkyEffect.Techniques["SkyBoxFake"];
