    ...
    public class PlayState : GameState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (ShouldReset)
            {
                ...
                Game.graphics.PreferredDepthStencilFormat = DepthFormat.Depth24;
        ...
        public void Load()
        {
            ...
            camera = new OrbitCamera(this, 0, 0, 10f, new Vector3(ChunkWidth, ChunkHeight - 1.0f, ChunkWidth) + GlobalOffset, new Vector3(0, 50, 0) + GlobalOffset, MathHelper.PiOver4, aspectRatio, 0.5f, GameSettings.Default.VertexCullDistance);
        ...
        public void DrawSky(GameTime time, Matrix view, bool reflected)
        {
        ...
        public override void Render(GameTime gameTime)
        {
            ...
            FogColor = new Color(new Vector3(0.32f * x, 0.58f * x, 0.9f * x));
            shader.Parameters["xFogColor"].SetValue(FogColor.ToVector3());
            ...
            DrawSky(gameTime, camera.ViewMatrix, false);
            ...
            shader.Parameters["Clipping"].SetValue(1);   
            ...
            shader.Parameters["Clipping"].SetValue(0);
            ...
            DwarfGame.SpriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.None, RasterizerState.CullCounterClockwise);
