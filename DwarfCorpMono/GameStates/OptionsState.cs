    ...
    public class OptionsState : GameState
    {
        ...
        public override void OnEnter()
        {
            ...
            foreach (DisplayMode mode in GraphicsAdapter.DefaultAdapter.SupportedDisplayModes)
            {
                ...
                DisplayModes[s] = mode;
                if (mode.Width == GameSettings.Default.ResolutionWidth && mode.Height == GameSettings.Default.ResolutionHeight)
                {
        ...
        void apply_OnClicked()
        {
            ...
            StateManager.Game.graphics.PreferredBackBufferWidth = GameSettings.Default.ResolutionWidth;
            StateManager.Game.graphics.PreferredBackBufferHeight = GameSettings.Default.ResolutionHeight;
        ...
        void resolutionBox_OnSelectionModified(string arg)
        {
            ...
            GameSettings.Default.ResolutionWidth = mode.Width;
            GameSettings.Default.ResolutionHeight = mode.Height; 
        }
