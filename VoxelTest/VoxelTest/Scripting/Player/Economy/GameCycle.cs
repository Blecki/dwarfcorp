...
namespace DwarfCorp
{
    ...
    /// <summary>
    /// A simple state machine saying what business cycle the game is in.
    /// This will need to change/become more complex. It's just saying that the
    /// balloon is at the colony, at the motherland, or traveling.
    /// </summary>
