...
namespace DwarfCorp
{
    public class NecromancerClass : EmployeeClass
    {
        ...
        void InitializeAnimations()
        {
            ...
            Texture2D sprites = TextureManager.GetTexture(ContentPaths.Entities.Skeleton.Sprites.necro);
        ...
        {
            MeleeAttack = new Attack("Spark", 2.0f, 1.0f, 1.0f, ContentPaths.Audio.fire)
            {
                Knockback = 2.5f,
