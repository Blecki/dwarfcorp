    ...
    public class GodModeController
    {
        ...
        public bool IsActive
        {
            ...
            set
            {
                ...
                if(value)
                {
                    orignalSelection = Master.VoxSelector.SelectionType;
                }

                Master.VoxSelector.SelectionType = GetSelectionType(value);
                ...
                else
                {
                    foreach(VoxelRef vox in refs)
                    {
                        ...
                        else if(command == "Fire")
                        {
                            ...
                            Master.Components.GetComponentsIntersecting(vox.GetBoundingBox(), components, CollisionManager.CollisionType.Dynamic | CollisionManager.CollisionType.Static);
