...
namespace DwarfCorp
{
    public class Goblin : Creature
    {
        ...
        public void Initialize(Texture2D GoblinSprites)
        {
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Walking, OrientedAnimation.Orientation.Right, GoblinSprites, 6.0f, frameWidth, frameHeight, 2, 0, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Walking, OrientedAnimation.Orientation.Left, GoblinSprites, 6.0f, frameWidth, frameHeight, 1, 0, 1);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Idle, OrientedAnimation.Orientation.Right, GoblinSprites, 0.8f, frameWidth, frameHeight, 2, 2, 0, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Idle, OrientedAnimation.Orientation.Left, GoblinSprites, 0.8f, frameWidth, frameHeight, 1, 1, 0, 1);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Attacking, OrientedAnimation.Orientation.Right, GoblinSprites, 5.0f, frameWidth, frameHeight, 10, 0, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Attacking, OrientedAnimation.Orientation.Left, GoblinSprites, 5.0f, frameWidth, frameHeight, 9, 0, 1);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Falling, OrientedAnimation.Orientation.Right, GoblinSprites, 6.0f, frameWidth, frameHeight, 6, 0);
            Sprite.AddAnimation(Creature.CharacterMode.Falling, OrientedAnimation.Orientation.Left, GoblinSprites, 6.0f, frameWidth, frameHeight, 5, 0);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Jumping, OrientedAnimation.Orientation.Right, GoblinSprites, 6.0f, frameWidth, frameHeight, 6, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Jumping, OrientedAnimation.Orientation.Left, GoblinSprites, 6.0f, frameWidth, frameHeight, 5, 1);
            ...
            Sprite.AddAnimation(Creature.CharacterMode.Swimming, OrientedAnimation.Orientation.Right, GoblinSprites, 6.0f, frameWidth, frameHeight, 14, 0, 1);
            Sprite.AddAnimation(Creature.CharacterMode.Swimming, OrientedAnimation.Orientation.Left, GoblinSprites, 6.0f, frameWidth, frameHeight, 13, 0, 1);
