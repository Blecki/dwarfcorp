...
namespace DwarfCorp
{
    ...
    public class TextureLoader
    {
        ...
        {
            string assemblyLocation = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + Program.DirChar + "DwarfCorp";
            string relativePath = assemblyLocation + Program.DirChar + folder;
            FileTypes = "*.png";
            Folder = relativePath;
            Graphics = graphics;
        }
