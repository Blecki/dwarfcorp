...
namespace DwarfCorp
{
    ...
    internal class GOAPStrings
    {
        ...
        public static string ZoneTags = "Target/ZoneTags";
        public static string HeldItemTags = "Hand/HeldItemTags";
        public static string MotionStatus = "MotionStatus";
        public static string CurrentZone = "CurrentZone";
