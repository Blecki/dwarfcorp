...
namespace DwarfCorp
{
    public class GUISkin
    {
        ...
        public void RenderButton(Rectangle rectbounds, SpriteBatch spriteBatch)
        {
            ...
            Rectangle rect = new Rectangle((int)(rectbounds.X + TileWidth / 4),
                                            (int)(rectbounds.Y),
                                                  w ,
                                                 h);
        ...
        public void RenderRadioButton(Rectangle rect, bool checkstate, SpriteBatch spriteBatch)
        {
            if (checkstate)
            {
                spriteBatch.Draw(Texture, rect, GetSourceRect(RadiobuttonPushed), Color.White);
            }
            else
            {
                spriteBatch.Draw(Texture, rect, GetSourceRect(Radiobutton), Color.White);
            }
        }
