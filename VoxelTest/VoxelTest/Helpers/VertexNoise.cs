...
namespace DwarfCorp
{
    ...
    internal class ColorNoise
    {
        ...
        private static float NoiseScale = 0.4f;
        private static float NoiseMagnitude = 100.0f;
        private static float GlobalNoiseScale = 0.003f;
        private static float GlobalNoiseMagnitude = 10.0f;
