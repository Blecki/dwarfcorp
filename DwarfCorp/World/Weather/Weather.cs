    ...
    public class Weather
    {
        ...
        public static List<Storm> CreateForecast(DateTime date, BoundingBox bounds, WorldManager world, int days)
        {
            ...
            for (int i = 0; i < days; i++)
            {
                ...
                float rain = world.Overworld.Map.GetValueAt(randomSample, OverworldField.Rainfall);
                float temperature = world.Overworld.Map.GetValueAt(randomSample, OverworldField.Temperature);
