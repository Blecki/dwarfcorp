    ...
    public class Weather
    {
        ...
        public static List<Storm> CreateForecast(DateTime date, BoundingBox bounds, WorldManager world, int days)
        {
            ...
            for (int i = 0; i < days; i++)
            {
                ...
                float rain = Overworld.GetValueAt(randomSample, OverworldField.Rainfall, world.WorldScale, world.WorldOrigin);
                float temperature = Overworld.GetValueAt(randomSample, OverworldField.Temperature, world.WorldScale, world.WorldOrigin);
