...
//#if false
                        else if (voxel.Type.GrassSpreadsHere)
                        {
                            ...
                            var biome = OverworldMap.GetBiomeAt(chunk.Manager.World.Settings.Overworld.Map, voxel.Coordinate.ToVector3(), chunk.Manager.World.Settings.InstanceSettings.Origin);
                            ...
                            var grassyNeighbors = VoxelHelpers.EnumerateManhattanNeighbors2D(voxel.Coordinate)
                                ...
                                .Where(v => biome == OverworldMap.GetBiomeAt(chunk.Manager.World.Settings.Overworld.Map, v.Coordinate.ToVector3(), chunk.Manager.World.Settings.InstanceSettings.Origin))
                                .ToList();
