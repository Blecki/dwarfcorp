...
namespace DwarfCorp.SteamPipes
{
    public class CheckValve : CraftedBody
    {
        ...
        public class CheckValveSteamObject : PipeNetworkObject
        {
            public override bool CanReceiveSteam(PipeNetworkObject Other)
            {
                return Orientation != OrientationHelper.DetectOrientationFromVector(Other.Position - Position);
            }

            public override bool CanSendSteam(PipeNetworkObject Other)
            {
                return Orientation == OrientationHelper.DetectOrientationFromVector(Other.Position - Position);
            }
