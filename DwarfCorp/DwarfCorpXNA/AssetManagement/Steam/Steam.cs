...
namespace DwarfCorp.AssetManagement.Steam
{
    ...
    public class Steam : IDisposable
    {
        ...
        public void CreateMod(string filepath)
        {
            ...
            SteamMetadata metadata = null;
            try
            {
                metadata = FileUtils.LoadJsonFromAbsolutePath<SteamMetadata>(filepath + Program.DirChar + "meta.json");
            }
            ...
            var item = Client.Workshop.CreateItem(Workshop.ItemType.Community);
