...
{
    public class StockTicker : Gui.Widget
    {
        ...
        protected override Gui.Mesh Redraw()
        {
            ...
            var columns = Gui.Mesh.Merge(EnumerateStockRange(StartHistory, EndHistory).Select(x =>
            {
                return Gui.Mesh.Quad().Scale(1.0f, GraphBox.Rect.Height)
            ...
            var graphLine = Gui.Mesh.Merge(EnumerateCompaniesInSector(SelectedSectors).SelectMany(c =>
            ...
            return Gui.Mesh.Merge(base.Redraw(), columns, graphLine);
        }
    }
}
