...
namespace DwarfCorp
{
    ...
    {
        public static MemoryTexture CropAndColorSprite(GraphicsDevice Device, Texture2D Sheet, Point FrameSize, Point Frame, Palette BasePalette, Palette Palette)
        {
        ...
        public static MemoryTexture CropSprite(GraphicsDevice Device, Texture2D Sheet, Point FrameSize, Point Frame)
        {
