...
namespace DwarfCorp
{
    public class DeconstructObjectTask : Task
    {
        public GameComponent EntityToKill = null;

        public DeconstructObjectTask()
        {
            MaxAssignable = 1;
        ...
        public DeconstructObjectTask(GameComponent entity)
        {
            MaxAssignable = 1;
        ...
        public override MaybeNull<Act> CreateScript(Creature creature)
        {
            ...
            return new DeconstructObjectAct(EntityToKill, creature.AI);
        }
