...
{
    public class DwarfCompositeTextureDebugPanel : Gui.Widget
    {
        ...
        {
            if (Parent.Parent is Gui.Widgets.TabPanel tabs && tabs.SelectedTab == 3)
            {
                var tiledInstanceGroup = World.Renderer.DwarfInstanceRenderer;
