...
{
    public class CommandMenuItemEnumerator
    {
        public static IEnumerable<CommandMenuItem> EnumerateCommandMenuItems(WorldManager World)
        {
            ...
            yield return new CommandMenuItem
            {
                ID = new List<String> { "Zone", "Destroy Zone" },
                DisplayName = "Destroy",
            ...
            foreach (var data in Library.EnumerateZoneTypes())
                yield return new CommandMenuItem
                {
                    ID = new List<String> { "Zone", data.DisplayName },
            ...
            yield return new CommandMenuItem
            {
                ID = new List<String> { "Object", "Move" },
            ...
            yield return new CommandMenuItem
            {
                ID = new List<String> { "Object", "Destroy" },
            ...
            foreach (var data in Library.EnumerateResourceTypes().Where(r => r.Craft_Craftable && !r.Disable))
                yield return new CommandMenuItem
                {
                    ...
                    DisplayName = objectNameToLabel(data.DisplayName),
                    OperationIcon = new ResourceType.GuiGraphic
                    {
                        AssetPath = "newgui//icons",
                        FrameSize = new Point(32, 32),
            ...
            foreach (var data in Library.EnumerateResourceTypes().Where(r => r.Placement_Placeable))
                yield return new CommandMenuItem
                {
                    ID = new List<string> { "Object", "Place", data.Category, data.DisplayName },
                    Icon = data.Gui_Graphic,
            ...
            yield return new CommandMenuItem
            {
                ID = new List<string> { "Object", "Rail", "Paint" },
            ...
            foreach (var data in Library.EnumerateRailPatterns())
                yield return new CommandMenuItem
                {
                    ID = new List<string> { "Object", "Rail", data.Name },
