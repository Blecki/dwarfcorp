                                ...
                                if (i < num)
                                {
                                    ...
                                    if (item.Name != "Explosive")
                                    {
                                        ...
                                        if (handle.IsValid)
                                        {
                                            ...
                                            List<ResourceAmount> resources = item.RequiredResources.Select(r => new ResourceAmount(Library.EnumerateResourceTypesWithTag(r.Type).First().Name, r.Count)).ToList();
