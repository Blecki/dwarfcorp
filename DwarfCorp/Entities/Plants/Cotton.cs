...
namespace DwarfCorp
{
    public class Cotton : Plant
    {
        ...
        public Cotton(ComponentManager Manager, Vector3 position) :
            base(Manager, "Cotton", position, MathFunctions.Rand(-0.1f, 0.1f), new Vector3(1.0f, 1.0f, 1.0f), "Entities\\Plants\\cotton", 1.0f)
        {
