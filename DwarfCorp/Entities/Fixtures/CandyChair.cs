...
namespace DwarfCorp
{
    ...
    {
        private static Point DefaultTopSprite = new Point(4, 4);
        private static Point DefaultLegsSprite = new Point(4, 3);
        ...
        {
            return new CandyChair(Manager, Position, Data.GetData<List<ResourceAmount>>("Resources", null), "Candy Chair", DefaultTopSprite, DefaultLegsSprite);
        }
        ...
        public CandyChair(ComponentManager manager, Vector3 position, List<ResourceAmount> resources, string craftType, Point topSprite, Point legsSprite) :
