...
namespace DwarfCorp
{
    ...
    public class Frog : Creature
    {
        ...
        public Frog(string sprites, Vector3 position, ComponentManager manager, ChunkManager chunks,
        ...
        public void Initialize(string sprites)
        {
            ...
            {
                new Attack("Bite", 0.01f, 2.0f, 1.0f, ContentPaths.Audio.frog, ContentPaths.Effects.bite)
            };
