...
namespace DwarfCorp
{
    ...
    public class LiquidPrimitive : GeometricPrimitive
    {
        ...
        private readonly Vector3[] faceDeltas = new Vector3[6];
        ...
        public void InitializeFromChunk(VoxelChunk chunk)
        {
            ...
            var maxY = (int) Math.Min(chunk.Manager.ChunkData.MaxViewingLevel + 1, chunk.SizeY);
                    ...
                    for (int z = 0; z < chunk.SizeZ; z++)
                    {
                        ...
                        if (chunk.Data.Water[index].WaterLevel > 0 && chunk.Data.Water[index].Type == LiqType)
                        {
                            ...
                            for (int i = 0; i < 6; i++)
                            {
                                ...
                                {
                                    var newVerts = new ExtendedVertex[Vertices.Length*2];
                                ...
                                bool success = chunk.Manager.ChunkData.GetVoxel(chunk,
                                    new Vector3(x + (int) delta.X, y + (int) delta.Y, z + (int) delta.Z) + chunk.Origin,
                                    ref vox);
                                ...
                                if (success)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        bool gotVox = chunk.Manager.ChunkData.GetVoxel(chunk,
                                            new Vector3(x, y + 1, z) + chunk.Origin, ref vox);
            ...
            int startVertex)
        {
            ...
            int vertOffset = 0;
            int numVerts = 0;
            primitive.GetFace(face, out idx, out vertexCount, out vertOffset, out numVerts);
            ...
            var neighborsVertex = new List<Voxel>();
            ...
            for (int i = 0; i < vertexCount; i ++)
            {
                ...
                float averageWaterHeight = averageWaterLevel/8.0f;
