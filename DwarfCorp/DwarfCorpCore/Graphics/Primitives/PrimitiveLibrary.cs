...
namespace DwarfCorp
{
    ...
    public class PrimitiveLibrary
    {
        ...
        public static Dictionary<string, BillboardPrimitive> BillboardPrimitives =
            new Dictionary<string, BillboardPrimitive>();

        public static Dictionary<string, BatchBillboardPrimitive> BatchBillboardPrimitives =
            new Dictionary<string, BatchBillboardPrimitive>();
        ...
        private static void CreateIntersecting(string name, string assetName, GraphicsDevice graphics,
            ContentManager content)
        {
            Texture2D bushSheet = TextureManager.GetTexture(assetName);
            var bushTransforms = new List<Matrix>();
            var bushColors = new List<Color>();
            ...
            BatchBillboardPrimitives[name] = new BatchBillboardPrimitive(bushSheet, bushSheet.Width, bushSheet.Height,
                new Point(0, 0), 1.0f, 1.0f, false, bushTransforms, bushColors, bushColors);
        }
        ...
        public void Initialize(GraphicsDevice graphics, ContentManager content)
        {
            if (!m_initialized)
            {
                ...
                var boxCoords = new OldBoxPrimitive.BoxTextureCoords(spriteSheet.Width, spriteSheet.Height,
                ...
                var bookshelfTexture = new OldBoxPrimitive.BoxTextureCoords(bookSheet.Width, bookSheet.Height,
                ...
                BoxPrimitives["bookshelf"] = new OldBoxPrimitive(graphics, 20.0f/32.0f, 32.0f/32.0f, 8.0f/32.0f,
                    bookshelfTexture);
                ...
                var crateCoords = new OldBoxPrimitive.BoxTextureCoords(sheetTiles.Width, sheetTiles.Height, 32, 32,
                    new Point(7, 0),
                    new Point(7, 0),
                    new Point(8, 0),
                    new Point(7, 0),
                ...
                var treeTransforms = new List<Matrix>();
                var treeTints = new List<Color>();
                treeTransforms.Add(Matrix.Identity);
                treeTransforms.Add(Matrix.CreateRotationY(1.57f));
                treeTints.Add(Color.White);
                treeTints.Add(Color.White);

                BatchBillboardPrimitives["pine"] = new BatchBillboardPrimitive(treeSheet, treeSheet.Width,
                    treeSheet.Height, new Point(0, 0), treeSheet.Width/32.0f, treeSheet.Height/32.0f, false,
                    treeTransforms, treeTints, treeTints);
                BatchBillboardPrimitives["snowpine"] = new BatchBillboardPrimitive(snowpineSheet, snowpineSheet.Width,
                    snowpineSheet.Height, new Point(0, 0), snowpineSheet.Width/32.0f, snowpineSheet.Height/32.0f, false,
                    treeTransforms, treeTints, treeTints);
                BatchBillboardPrimitives["palm"] = new BatchBillboardPrimitive(palmSheet, palmSheet.Width,
                    palmSheet.Height, new Point(0, 0), palmSheet.Width/32.0f, palmSheet.Height/32.0f, false,
                    treeTransforms, treeTints, treeTints);


                var motes = new List<string>
                {
                    "berrybush",
                    "cactus",
                    "frostgrass",
